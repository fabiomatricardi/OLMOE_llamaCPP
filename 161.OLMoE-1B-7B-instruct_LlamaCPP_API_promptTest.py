...
import datetime
from promptLibv2OLMO import countTokens, writehistory, createCatalog
from promptLibv2OLMO import genRANstring, createStats
import argparse
...
tasks = createCatalog()
NCTX = 4096
modelname = 'OLMoE-1B-7B-0924-Instruct-Q4_K_L.gguf'
# create THE LOG FILE 
coded5 = genRANstring(5)
logfile = f'logs/OLMoE-1B-7B-0924-Instruct_CPP_{coded5}_log.txt'
csvfile = f'logs/OLMoE-1B-7B-0924-Instruct_CPP_{coded5}.csv'
logfilename = logfile
